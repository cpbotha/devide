...
class aboutDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.name_version_text = wx.StaticText(self.toplevel_panel, -1, "DeVIDE 8.2.0000", style=wx.ALIGN_CENTRE)
        self.icon_bitmap = wx.StaticBitmap(self.toplevel_panel, -1, wx.NullBitmap)
        self.label_2 = wx.StaticText(self.toplevel_panel, -1, "DeVIDE is copyright (c) 2002-2008 Charl P. Botha\nhttp://visualisation.tudelft.nl/Projects/DeVIDE", style=wx.ALIGN_CENTRE)
