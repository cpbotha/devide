...
class graphEditorFrame(wxFrame):
	...
	del kwds['wxpcCanvas']
        ...
        wxglade_tmp_menu.Append(self.fileNewId , "&New", "Create new network.", wxITEM_NORMAL)
        wxglade_tmp_menu.Append(self.fileOpenId , "&Open", "Open and load existing network.", wxITEM_NORMAL)
        wxglade_tmp_menu.Append(self.fileOpenSegmentId , "O&pen as Segment", "Open a DSCAS3 network as a segment in the copy buffer.", wxITEM_NORMAL)
        wxglade_tmp_menu.Append(self.fileSaveId , "&Save", "Save the current network.", wxITEM_NORMAL)
        wxglade_tmp_menu.Append(self.fileSaveSelectedId , "Save selected &Glyphs", "Save the selected glyphs as a network.", wxITEM_NORMAL)
        wxglade_tmp_menu.AppendSeparator()
        wxglade_tmp_menu.Append(self.fileExitId , "E&xit", "Exit DSCAS3!", wxITEM_NORMAL)
