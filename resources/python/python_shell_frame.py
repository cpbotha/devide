...
# generated by wxGlade 0.4.1 on Fri Jul 07 13:08:23 2006
...
class PyShellFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        # begin wxGlade: PyShellFrame.__init__
        ...
        self.file_new_id = wx.NewId()
        self.file_open_id = wx.NewId()
        self.file_close_id = wx.NewId()
        self.file_save_id = wx.NewId()
        self.file_saveas_id = wx.NewId()
        self.run_id = wx.NewId()
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(self.file_new_id, "New &Tab\tCtrl-T", "Create a new tab / edit to work in.", wx.ITEM_NORMAL)
        ...
        wxglade_tmp_menu.Append(self.file_close_id, "Close tab / edit\tCtrl-W", "Close the current edit / tab.", wx.ITEM_NORMAL)
        wxglade_tmp_menu.AppendSeparator()
        wxglade_tmp_menu.Append(self.file_save_id, "&Save current edit\tCtrl-S", "Save current edit tab to file", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(self.file_saveas_id, "Save current edit as (new filename)", "Save current edit to new file.", wx.ITEM_NORMAL)
        wxglade_tmp_menu.AppendSeparator()
        ...
        self.default_editwindow = module_kits.wx_kit.dvedit_window.DVEditWindow(self.notebook_1_pane_1, -1)
    ...
    def __set_properties(self):
        # begin wxGlade: PyShellFrame.__set_properties
        self.SetTitle("Python Shell")
    ...
    def __do_layout(self):
        # begin wxGlade: PyShellFrame.__do_layout
        ...
        sizer_6.Add(self.default_editwindow, 1, wx.LEFT|wx.RIGHT|wx.EXPAND, 7)
        ...
        self.edit_notebook.AddPage(self.notebook_1_pane_1, "Unnamed")
