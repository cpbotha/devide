...
# * remove vtk_plydta_rdr.py and vtk_plydta_rdr.xml from the repository
...
class vtk_plydta_rdr(moduleBase, filenameViewModuleMixin):
    ...
    def executeModule(self):
        ...
        mm.setProgress(100, 'DONE reading vtk PolyData')
