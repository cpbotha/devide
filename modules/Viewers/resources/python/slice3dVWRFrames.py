...
class controlFrame(wxFrame):
    def __init__(self, *args, **kwds):
        ...
        self.text_ctrl_1 = wxTextCtrl(self.notebook_1_pane_2, -1, "")
        self.label_4_2_copy = wxStaticText(self.notebook_1_pane_2, -1, "Type")
        self.choice_1 = wxChoice(self.notebook_1_pane_2, -1, choices=["choice 1"])
        ...
        self.implicitGrid = wxGrid(self.notebook_1_pane_2, -1)
    ...
    def __set_properties(self):
        ...
        self.implicitGrid.CreateGrid(2, 4)
        self.implicitGrid.EnableEditing(0)
        self.implicitGrid.EnableDragRowSize(0)
        self.implicitGrid.EnableDragGridSize(0)
        self.implicitGrid.SetSelectionMode(wxGrid.wxGridSelectRows)
        self.implicitGrid.SetColLabelValue(0, "Name")
        self.implicitGrid.SetColLabelValue(1, "Type")
        self.implicitGrid.SetColLabelValue(2, "Enabled")
        self.implicitGrid.SetColLabelValue(3, "Interaction")
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        selectedPointsCursorSizer_copy.Add(self.text_ctrl_1, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 4)
        selectedPointsCursorSizer_copy.Add(self.label_4_2_copy, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 3)
        selectedPointsCursorSizer_copy.Add(self.choice_1, 1, wxRIGHT|wxALIGN_CENTER_VERTICAL, 7)
        ...
        sizer_25.Add(self.implicitGrid, 1, wxEXPAND, 0)
