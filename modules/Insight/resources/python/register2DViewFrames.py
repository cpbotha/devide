...
class viewerFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.button_3 = wx.Button(self.viewPanel, -1, "Reset Camera")
...
class controlFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.pairNumberSpinCtrl = wx.SpinCtrl(self.panel_2, -1, "", min=0, max=100, style=wx.SP_ARROW_KEYS)
        ...
        self.button_5 = wx.Button(self.panel_2, -1, "Trfm")
