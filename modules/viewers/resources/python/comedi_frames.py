#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Wed Apr 29 16:26:35 2009
...
class CoMedIControlsFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.source_landmarks_olv = ObjectListView(self.notebook_pane_ssl, -1, style=wx.LC_REPORT|wx.SUNKEN_BORDER, cellEditMode=ObjectListView.CELLEDIT_DOUBLECLICK)
        self.label_3 = wx.StaticText(self.notebook_pane_ssl, -1, "Target landmarks")
        self.target_landmarks_olv = ObjectListView(self.notebook_pane_ssl, -1, style=wx.LC_REPORT|wx.SUNKEN_BORDER, cellEditMode=ObjectListView.CELLEDIT_DOUBLECLICK)
