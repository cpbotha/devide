#!/usr/bin/env python
# -*- coding: iso-8859-1 -*-
# generated by wxGlade 0.6.3 on Wed Jul 23 13:32:41 2008
...
class TFEditorFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.sizer_6_staticbox = wx.StaticBox(self.view_frame_panel, -1, "Built-in presets")
        self.sizer_11_staticbox = wx.StaticBox(self.view_frame_panel, -1, "Saving, Loading")
        self.sizer_8_staticbox = wx.StaticBox(self.view_frame_panel, -1, "Edit Transfer Function")
        ...
        self.auto_range_button = wx.Button(self.view_frame_panel, -1, "Get input range")
        ...
        self.load_preset_button = wx.Button(self.view_frame_panel, -1, "Load preset")
        self.file_load_button = wx.Button(self.view_frame_panel, -1, "Load from file")
        self.file_save_button = wx.Button(self.view_frame_panel, -1, "Save to file")
    ...
    def __set_properties(self):
        ...
        self.colour_button.SetToolTipString("Change colour of currently selected transfer function vertex.")
        self.cur_col_text.SetMinSize((75, -1))
        self.cur_opacity_text.SetMinSize((50, -1))
        self.delete_button.SetToolTipString("Delete the currently selected vertex.")
        self.auto_range_button.SetToolTipString("Determine scalar range from input data.  Input data has to be up to date.")
        self.apply_range_button.SetToolTipString("Apply the entered scalar range to the transfer function.")
        self.preset_choice.SetSelection(0)
        self.load_preset_button.SetToolTipString("Load the selected preset.")
        self.file_load_button.SetToolTipString("Load a DVTF file.")
        self.file_save_button.SetToolTipString("Save current transfer function to a DVTF file.")
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        sizer_8.Add(sizer_4, 1, wx.ALL|wx.EXPAND, 7)
        ...
        sizer_8.Add(sizer_7, 0, wx.LEFT|wx.RIGHT|wx.BOTTOM|wx.EXPAND, 7)
        ...
        sizer_8.Add(sizer_5, 0, wx.LEFT|wx.RIGHT|wx.BOTTOM|wx.EXPAND, 7)
        sizer_3.Add(sizer_8, 1, wx.BOTTOM|wx.EXPAND, 7)
        sizer_3.Add((400, 0), 0, 0, 0)
        sizer_13.Add(self.label_3, 0, wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, 4)
        sizer_13.Add(self.preset_choice, 1, wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, 7)
        sizer_13.Add(self.load_preset_button, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_6.Add(sizer_13, 1, wx.ALL|wx.EXPAND, 7)
        sizer_10.Add(sizer_6, 1, wx.RIGHT, 7)
        sizer_12.Add(self.file_load_button, 0, wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, 4)
        sizer_12.Add(self.file_save_button, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_11.Add(sizer_12, 1, wx.ALL|wx.EXPAND, 7)
        sizer_10.Add(sizer_11, 0, 0, 7)
