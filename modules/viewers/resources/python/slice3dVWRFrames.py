...
class threedFrame(wxFrame):
    def __init__(self, *args, **kwds):
        ...
        self.introspectButton = wxButton(self.panel_1, -1, "Introspect")
        self.introspectPipelineButtonId = wxNewId()
        self.button_5 = wxButton(self.panel_1, self.introspectPipelineButtonId, "Pipeline")
        self.saveImageButton = wxButton(self.panel_1, -1, "Save Image")
    ...
    def __do_layout(self):
        ...
        sizer_15.Add(self.projectionChoice, 0, wxBOTTOM|wxEXPAND, 4)
        sizer_15.Add((0, 20), 0, 0, 0)
        sizer_15.Add(self.introspectButton, 0, wxBOTTOM|wxEXPAND, 4)
...
class controlFrame(wxFrame):
    def __init__(self, *args, **kwds):
        ...
        self.sizer_17_staticbox = wxStaticBox(self.notebook_1_pane_1, -1, "Selected Points")
        self.sizer_19_staticbox = wxStaticBox(self.notebook_1_pane_1, -1, "Objects")
        self.sizer_25_staticbox = wxStaticBox(self.notebook_1_pane_2, -1, "Implicits")
        self.sizer_20_staticbox = wxStaticBox(self.notebook_1_pane_2, -1, "Volume of Interest Extraction")
        self.sizer_18_staticbox = wxStaticBox(self.notebook_1_pane_1, -1, "Slices")
        ...
        self.sliceGrid = wxGrid(self.notebook_1_pane_1, -1, size=(1, 1))
        self.label_5 = wxStaticText(self.notebook_1_pane_1, -1, "Overlay mode")
        self.overlayModeChoice = wxChoice(self.notebook_1_pane_1, -1, choices=["Fusion musion long", "Another thingy for the", "And perhaps the last", "But not quite"])
        self.label_6 = wxStaticText(self.notebook_1_pane_1, -1, "Alpha")
        self.fusionAlphaSlider = wxSlider(self.notebook_1_pane_1, -1, 40, 0, 100, style=wxSL_HORIZONTAL|wxSL_LABELS)
        self.label_1_2 = wxStaticText(self.notebook_1_pane_1, -1, "Discrete")
        self.sliceCursorDiscreteText = wxTextCtrl(self.notebook_1_pane_1, -1, "")
        self.label_8 = wxStaticText(self.notebook_1_pane_1, -1, "World")
        self.sliceCursorWorldText = wxTextCtrl(self.notebook_1_pane_1, -1, "")
        self.label_9 = wxStaticText(self.notebook_1_pane_1, -1, "Scalars")
        self.sliceCursorScalarsText = wxTextCtrl(self.notebook_1_pane_1, -1, "")
        ...
        self.pointsGrid = wxGrid(self.notebook_1_pane_1, -1, size=(1, 1))
        ...
        self.objectsListGrid = wxGrid(self.notebook_1_pane_1, -1, size=(1, 1))
        ...
        self.implicitsGrid = wxGrid(self.notebook_1_pane_2, -1, size=(1, 1))
        self.voiEnabledCheckBoxId = wxNewId()
        self.voiEnabledCheckBox = wxCheckBox(self.notebook_1_pane_2, self.voiEnabledCheckBoxId, "Enabled")
        self.label_10 = wxStaticText(self.notebook_1_pane_2, -1, "Size automatically:")
        self.voiAutoSizeChoice = wxChoice(self.notebook_1_pane_2, -1, choices=["Selected points bounding box", "Selected 3D objects bounding box", "Visible objects bounding box"])
        ...
        self.label_11 = wxStaticText(self.notebook_1_pane_2, -1, "VOI filename (.VTI)")
        self.voiFilenameText = wxTextCtrl(self.notebook_1_pane_2, -1, "")
        self.voiFilenameBrowseButton = wxButton(self.notebook_1_pane_2, -1, "Browse")
        self.voiSaveButton = wxButton(self.notebook_1_pane_2, -1, "Save")
        self.voiResetToOriginCheck = wxCheckBox(self.notebook_1_pane_2, -1, "Reset to zero origin")
    ...
    def __do_layout(self):
        ...
        sizer_29.Add(self.sliceGrid, 1, wxEXPAND, 4)
        sizer_29.Add((0, 125), 0, 0, 0)
        sizer_18.Add(sizer_29, 1, wxEXPAND, 0)
        sizer_18.Add((500, 0), 0, 0, 0)
        sizer_27.Add(self.label_5, 0, wxRIGHT, 4)
        sizer_27.Add(self.overlayModeChoice, 1, wxRIGHT|wxEXPAND, 7)
        ...
        sizer_28.Add(self.sliceCursorWorldText, 1, wxRIGHT|wxEXPAND|wxALIGN_CENTER_VERTICAL, 7)
        sizer_28.Add(self.label_9, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 4)
        sizer_28.Add(self.sliceCursorScalarsText, 1, wxEXPAND|wxALIGN_CENTER_VERTICAL, 7)
        sizer_17.Add(sizer_28, 0, wxLEFT|wxRIGHT|wxTOP|wxEXPAND, 7)
        selectedPointsCursorSizer.Add(self.label_4_2, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 4)
        ...
        sizer_17.Add(selectedPointsCursorSizer, 0, wxALL|wxEXPAND, 7)
        sizer_30.Add(self.pointsGrid, 1, wxEXPAND, 4)
        ...
        sizer_21.Add(self.voiAutoSizeChoice, 1, wxEXPAND, 0)
        sizer_20.Add(sizer_21, 0, wxTOP|wxBOTTOM|wxEXPAND, 7)
        sizer_32.Add(self.label_7, 0, wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL, 2)
        sizer_32.Add(self.voiBoundsText, 1, wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL, 2)
        sizer_32.Add(self.label_7_1, 0, wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL, 2)
        sizer_32.Add(self.voiExtentText, 1, wxLEFT|wxRIGHT|wxALIGN_CENTER_VERTICAL, 2)
        sizer_20.Add(sizer_32, 1, wxBOTTOM|wxEXPAND, 7)
        sizer_33.Add(self.label_11, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 3)
        sizer_33.Add(self.voiFilenameText, 1, wxRIGHT|wxALIGN_CENTER_VERTICAL, 3)
        sizer_33.Add(self.voiFilenameBrowseButton, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 3)
        sizer_33.Add(self.voiSaveButton, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 3)
        sizer_33.Add(self.voiResetToOriginCheck, 0, wxALIGN_CENTER_VERTICAL, 0)
        sizer_20.Add(sizer_33, 1, wxBOTTOM|wxEXPAND, 7)
        sizer_24.Add(sizer_20, 0, wxEXPAND, 7)
        sizer_23.Add(sizer_24, 0, wxALL|wxEXPAND, 7)
