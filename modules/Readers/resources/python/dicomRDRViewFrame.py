...
class dicomRDRViewFrame(wxFrame):
    def __init__(self, *args, **kwds):
        ...
        self.label_1_copy = wxStaticText(self.viewFramePanel, -1, "DICOM Directory")
        ...
        self.label_4_copy = wxStaticText(self.viewFramePanel, -1, "Series Instance Index")
        ...
        self.label_5_copy = wxStaticText(self.viewFramePanel, -1, "UID")
        self.si_uid_text = wxTextCtrl(self.viewFramePanel, -1, "", style=wxTE_READONLY|wxHSCROLL)
        self.label_9_copy = wxStaticText(self.viewFramePanel, -1, "Study Description:")
        self.study_description_text = wxTextCtrl(self.viewFramePanel, -1, "", style=wxTE_READONLY|wxHSCROLL)
        self.label_10_copy = wxStaticText(self.viewFramePanel, -1, "Referring Physician:")
        self.referring_physician_text = wxTextCtrl(self.viewFramePanel, -1, "", style=wxTE_READONLY|wxHSCROLL)
        self.label_11_copy = wxStaticText(self.viewFramePanel, -1, "Dimensions:")
    ...
    def __do_layout(self):
        ...
        sizer_3.Add(self.label_1_copy, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 3)
        ...
        sizer_6.Add(sizer_3, 1, wxALL|wxEXPAND, 7)
        sizer_5.Add(self.label_4_copy, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 3)
        sizer_5.Add(self.si_idx_spin, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 4)
        sizer_5.Add(self.label_5_copy, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 3)
        sizer_5.Add(self.si_uid_text, 1, wxALIGN_CENTER_VERTICAL, 0)
        sizer_6.Add(sizer_5, 1, wxLEFT|wxRIGHT|wxBOTTOM|wxEXPAND, 7)
        ...
        sizer_6.Add(mdata_sizer, 0, wxLEFT|wxRIGHT|wxBOTTOM|wxEXPAND, 7)
