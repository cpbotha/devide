...
class decimateFLTViewFrame(wxFrame):
    def __init__(self, *args, **kwds):
        ...
        self.label_8_copy_1 = wxStaticText(self.panel_1, -1, "Target reduction (%)")
        self.targetReductionSlider = wxSlider(self.panel_1, -1, 0, 0, 100, style=wxSL_HORIZONTAL|wxSL_AUTOTICKS|wxSL_LABELS)
        self.label_1_copy_1 = wxStaticText(self.panel_1, -1, "Examine the")
        self.objectChoiceId  =  wxNewId()
        self.objectChoice = wxChoice(self.panel_1, self.objectChoiceId , choices=["vtkDecimate", "vtkTriangleFilter"])
    ...
    def __do_layout(self):
        ...
        sizer_3.Add(self.targetReductionSlider, 1, wxLEFT|wxRIGHT, 4)
