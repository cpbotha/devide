...
class rawVolumeRDRViewFrame(wxFrame):
    def __init__(self, *args, **kwds):
        ...
        self.label_1 = wxStaticText(self.panel_1, -1, "Filename")
        self.filenameText = wxTextCtrl(self.panel_1, -1, "")
        self.browseButtonId  =  wxNewId()
        self.button_1 = wxButton(self.panel_1, self.browseButtonId , "Browse")
        self.label_3 = wxStaticText(self.panel_1, -1, "Data type")
        self.dataTypeChoice = wxChoice(self.panel_1, -1, choices=["choice 1"])
        self.endiannessRadioBox = wxRadioBox(self.panel_1, -1, "Endianness", choices=["Little (LSB at lowest address)", "Big (MSB at lowest address)"], majorDimension=2, style=wxRA_SPECIFY_COLS)
        self.label_2 = wxStaticText(self.panel_1, -1, "Header size (bytes)")
        self.headerSizeText = wxTextCtrl(self.panel_1, -1, "0")
        self.label_4 = wxStaticText(self.panel_1, -1, "Extent (x0, x1, y0, y1, z0, z1)")
        self.extentText = wxTextCtrl(self.panel_1, -1, "")
        self.label_5 = wxStaticText(self.panel_1, -1, "Spacing (Sx, Sy, Sz)")
