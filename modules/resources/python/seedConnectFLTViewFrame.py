...
class seedConnectFLTViewFrame(wxFrame):
    def __init__(self, *args, **kwds):
        ...
        self.label_1 = wxStaticText(self.panel_1, -1, "Input Connect Value")
        self.inputConnectValueText = wxTextCtrl(self.panel_1, -1, "")
        self.label_2 = wxStaticText(self.panel_1, -1, "Output Connected Value")
        self.outputConnectedValueText = wxTextCtrl(self.panel_1, -1, "")
        self.label_3 = wxStaticText(self.panel_1, -1, "Output Unconnected Value")
        self.outputUnconnectedValueText = wxTextCtrl(self.panel_1, -1, "")
        self.label_1_copy_1 = wxStaticText(self.panel_1, -1, "Examine the")
        self.objectChoiceId  =  wxNewId()
        self.objectChoice = wxChoice(self.panel_1, self.objectChoiceId , choices=["vtkImageSeedConnectivity"])
