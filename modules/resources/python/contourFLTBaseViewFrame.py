...
class contourFLTBaseViewFrame(wxFrame):
    def __init__(self, *args, **kwds):
        ...
        self.isoValueText = wxTextCtrl(self.panel_1, self.isoValueTextId , "")
        self.realtimeUpdateCheckBoxId  =  wxNewId()
        self.realtimeUpdateCheckBox = wxCheckBox(self.panel_1, self.realtimeUpdateCheckBoxId , "Real-time update of output at text-input <ENTER>")
        self.label_1_copy_1 = wxStaticText(self.panel_1, -1, "Examine the")
        self.objectChoiceId  =  wxNewId()
        self.objectChoice = wxChoice(self.panel_1, self.objectChoiceId , choices=["VTK Contour Filter"])
