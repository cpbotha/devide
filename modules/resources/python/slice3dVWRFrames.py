...
class controlFrame(wxFrame):
    def __init__(self, *args, **kwds):
        ...
        kwds["style"] = wxDEFAULT_FRAME_STYLE
        wxFrame.__init__(self, *args, **kwds)
        self.createSliceComboBox = wxComboBox(self, -1, choices=["Scapula lateral edge", "Scapula spina", "Axial", "Coronal", "Sagittal"], style=wxCB_DROPDOWN)
        self.createSliceButtonId  =  wxNewId()
        self.button_2_2 = wxButton(self, self.createSliceButtonId , "Create Slice")
        self.sliceGrid = wxGrid(self, -1)
        self.sliceSelectAllButtonId  =  wxNewId()
        self.selectAllSlicesButton = wxButton(self, self.sliceSelectAllButtonId , "Select All")
        self.sliceDeselectAllButtonId  =  wxNewId()
        self.button_8 = wxButton(self, self.sliceDeselectAllButtonId , "Deselect All")
        self.sliceShowHideButtonId  =  wxNewId()
        self.button_14 = wxButton(self, self.sliceShowHideButtonId , "Show/Hide")
        self.sliceInteractionButtonId  =  wxNewId()
        self.button_15 = wxButton(self, self.sliceInteractionButtonId , "Interaction")
        self.button_18 = wxButton(self, -1, "Ortho")
        self.acsChoiceId  =  wxNewId()
        self.acsChoice = wxChoice(self, self.acsChoiceId , choices=["Reset to Axial", "Reset to Coronal", "Reset to Sagittal"])
        self.pushSliceSpinCtrlId  =  wxNewId()
        self.pushSliceSpinCtrl = wxSpinCtrl(self, self.pushSliceSpinCtrlId , "0", min=-100, max=100, style=wxSP_ARROW_KEYS)
        self.sliceDeleteButtonId  =  wxNewId()
        self.button_16 = wxButton(self, self.sliceDeleteButtonId , "Delete")
        self.label_1_2 = wxStaticText(self, -1, "Cursor at")
        self.sliceCursorText = wxTextCtrl(self, -1, "")
        self.label_4_2 = wxStaticText(self, -1, "Name")
        self.sliceCursorNameCombo = wxComboBox(self, -1, choices=["Point 1", "Point 2", "Point 3", "Point 4"], style=wxCB_DROPDOWN)
        self.sliceStoreButtonId  =  wxNewId()
        self.button_6_2 = wxButton(self, self.sliceStoreButtonId , "Store this point")
        self.spointsGrid = wxGrid(self, -1)
        self.pointsSelectAllButtonId  =  wxNewId()
        self.pointsSelectAllButton = wxButton(self, self.pointsSelectAllButtonId , "Select all")
        self.pointsDeselectAllButtonId  =  wxNewId()
        self.pointsDeselectAllButton = wxButton(self, self.pointsDeselectAllButtonId , "Deselect all")
        self.pointsLockSliceButtonId  =  wxNewId()
        self.button_12 = wxButton(self, self.pointsLockSliceButtonId , "Lock Slice")
        self.pointsRemoveButtonId  =  wxNewId()
        self.pointsRemoveButton = wxButton(self, self.pointsRemoveButtonId , "Delete")
        self.pointInteractionCheckBoxId  =  wxNewId()
        self.pointInteractionCheckBox = wxCheckBox(self, self.pointInteractionCheckBoxId , "3D Point Interaction")
        self.label_5_1 = wxStaticText(self, -1, "When I click on an object in the scene,")
        self.surfacePickActionChoice = wxChoice(self, -1, choices=["do nothing.", "place a point on its surface.", "configure the object.", "show the scalar bar for its input."])
        self.objectsListGrid = wxGrid(self, -1)
        self.objectSelectAllButtonId  =  wxNewId()
        self.button_9_1 = wxButton(self, self.objectSelectAllButtonId , "Select All")
        self.objectDeselectAllButtonId  =  wxNewId()
        self.button_10_1 = wxButton(self, self.objectDeselectAllButtonId , "Deselect All")
        self.objectShowHideButtonId  =  wxNewId()
        self.button_3_1 = wxButton(self, self.objectShowHideButtonId , "Show/Hide")
        self.objectSetColourButtonId  =  wxNewId()
        self.button_2_1 = wxButton(self, self.objectSetColourButtonId , "Set Colour")
        self.objectContourButtonId  =  wxNewId()
        self.button_4_1 = wxButton(self, self.objectContourButtonId , "Contour")
        self.objectMotionButtonId  =  wxNewId()
        self.button_11_1 = wxButton(self, self.objectMotionButtonId , "Motion")
        self.objectAxisToSliceButtonId  =  wxNewId()
        self.button_13_1 = wxButton(self, self.objectAxisToSliceButtonId , "Axis to Slice")
        self.voiEnabledCheckBoxId  =  wxNewId()
        self.voiEnabledCheckBox = wxCheckBox(self, self.voiEnabledCheckBoxId , "VOI extraction:")
        self.label_7 = wxStaticText(self, -1, "Bounds")
        self.voiBoundsText = wxTextCtrl(self, -1, "", style=wxTE_READONLY)
        self.label_7_1 = wxStaticText(self, -1, "Discrete")
        self.voiExtentText = wxTextCtrl(self, -1, "")
    ...
    def __set_properties(self):
        ...
        self.spointsGrid.CreateGrid(2, 3)
        ...
        self.spointsGrid.SetSize((500, 100))
    ...
    def __do_layout(self):
        ...
        slicerButtons2Sizer.Add(self.pushSliceSpinCtrl, 0, wxALIGN_CENTER_VERTICAL, 7)
        slicerButtons2Sizer.Add(self.button_16, 0, wxRIGHT|wxALIGN_CENTER_VERTICAL, 7)
        sizer_18.Add(slicerButtons2Sizer, 0, wxALL, 4)
        sizer_16.Add(sizer_18, 0, wxLEFT|wxRIGHT|wxTOP, 7)
        ...
        sizer_17.Add(self.spointsGrid, 1, wxEXPAND, 4)
        ...
        selectedPointsButtons1Sizer.Add(self.button_12, 0, wxRIGHT, 4)
        ...
        sizer_16.Add(sizer_17, 0, wxLEFT|wxRIGHT|wxTOP, 7)
        ...
        sizer_16.Add(sizer_19, 0, wxLEFT|wxRIGHT|wxTOP, 7)
        ...
        sizer_16.Add(sizer_20, 0, wxALL|wxEXPAND, 7)
        self.SetAutoLayout(1)
