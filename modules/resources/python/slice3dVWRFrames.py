...
class MainFrame(wxFrame):
    def __init__(self, *args, **kwds):
        ...
        self.button_7 = wxButton(self.panel_1, self.resetCameraButtonId , "Reset Camera")
        self.resetAllButtonId  =  wxNewId()
        self.button_8 = wxButton(self.panel_1, self.resetAllButtonId , "Reset All")
    ...
    def __set_properties(self):
        ...
        self.spointsGrid.SetSize((659, 133))
        ...
        self.notebook_1_copy.SetSize((663, 260))
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        sizer_14.Add(self.button_7, 0, wxRIGHT, 4)
        sizer_14.Add(self.button_8, 0, 0, 0)
        sizer_12.Add(sizer_14, 0, wxBOTTOM|wxALIGN_CENTER_HORIZONTAL, 7)
        sizer_12.Add(self.static_line_1, 0, wxEXPAND, 0)
        ...
        sizer_12.Add(grid_sizer_1, 1, wxTOP|wxEXPAND, 7)
