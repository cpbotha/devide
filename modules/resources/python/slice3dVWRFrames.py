...
class MainFrame(wxFrame):
    def __init__(self, *args, **kwds):
        ...
        self.surfacePickActionRB = wxRadioBox(self.notebook_1_pane_3_copy, -1, "Surface pick action", choices=["None", "Place point", "Configure picked object", "Show scalar bar for picked object"], majorDimension=1, style=wxRA_SPECIFY_COLS)
    ...
    def __set_properties(self):
        ...
        self.spointsGrid.SetSize((491, 174))
