...
class MainFrame(wxFrame):
    def __init__(self, *args, **kwds):
        ...
        self.surfacePickActionRB = wxRadioBox(self.notebook_1_pane_3_copy, -1, "When I select an object:", choices=["Do nothing", "Place a point on its surface", "Configure the object", "Show a scalar bar for its input", "Move the object"], majorDimension=1, style=wxRA_SPECIFY_COLS)
        self.sliceNameChoiceId  =  wxNewId()
        self.sliceNameChoice = wxChoice(self.panel_1, self.sliceNameChoiceId , choices=["choice 1"])
        ...
        self.sliceCursorNameCombo = wxComboBox(self.panel_1, -1, choices=["Point 1", "Point 2", "Point 3", "Point 4"], style=wxCB_DROPDOWN)
        self.sliceStoreButtonId  =  wxNewId()
        self.button_6_copy_copy = wxButton(self.panel_1, self.sliceStoreButtonId , "Store Point")
    ...
    def __set_properties(self):
        ...
        self.spointsGrid.SetSize((448, 190))
    ...
    def __do_layout(self):
        ...
        grid_sizer_5.Add(self.sliceNameChoice, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL, 0)
        grid_sizer_5.Add(self.button_3, 0, wxALIGN_CENTER_VERTICAL, 0)
        grid_sizer_5.Add(self.createSliceText, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL, 0)
        grid_sizer_5.Add(self.button_2, 0, wxALIGN_CENTER_VERTICAL, 0)
        grid_sizer_5.AddGrowableCol(0)
        sizer_21.Add(grid_sizer_5, 0, wxALL|wxEXPAND, 2)
        ...
        sizer_3.Add(self.acsChoice, 0, wxALL|wxALIGN_CENTER_VERTICAL, 2)
        ...
        grid_sizer_1_copy_copy.Add(self.sliceCursorNameCombo, 0, wxEXPAND|wxALIGN_CENTER_VERTICAL, 0)
        ...
        sizer_9.Add(sizer_21, 0, wxEXPAND, 0)
