...
# we should use hooks for this...
mod_dir = os.path.join(D3_DIR, 'modules')
mods = [(os.path.join('modules', i), os.path.join(mod_dir, i), 'DATA')
...
a = Analysis(['/home/cpbotha/build/Installer/support/useUnicode.py', '/home/cpbotha/work/code/dscas3/dscas3.py'],
...
coll = COLLECT(exe,
               a.binaries + main_xrcs + mods + mod_xrcs + misc,
               name='distdscas3')
